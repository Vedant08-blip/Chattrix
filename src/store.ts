...
const mockUsers: { [id: string]: User } = {
  ...
  'ananya': {
    id: 'ananya',
    name: 'Ananya',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Ananya&facialHairProbability=0&topType=longHairStraight',
    presence: 'online',
  ...
  'kabir': {
    id: 'kabir',
    name: 'Kabir',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Kabir&topType=shortHairTheCaesar',
    presence: 'idle',
  ...
  'rohan': {
    id: 'rohan',
    name: 'Rohan',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Rohan&topType=shortHairShortFlat',
    presence: 'dnd',
  ...
  'devansh': {
    id: 'devansh',
    name: 'Devansh',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Devansh&topType=shortHairShortRound',
    presence: 'online',
  ...
  'isha': {
    id: 'isha',
    name: 'Isha',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Isha&facialHairProbability=0&topType=longHairBob',
    presence: 'offline',
  ...
  'farhan': {
    id: 'farhan',
    name: 'Farhan',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Farhan&topType=shortHairSides',
    presence: 'online',
  ...
  'gauri': {
    id: 'gauri',
    name: 'Gauri',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Gauri&facialHairProbability=0&topType=longHairCurly',
    presence: 'online',
    mutualServers: ['Developer Hangout'],
    role: 'Member'
  },
  'harshita': {
    id: 'harshita',
    name: 'Harshita',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Harshita&facialHairProbability=0&topType=longHairBigHair',
    presence: 'idle',
    mutualServers: ['Developer Hangout'],
    role: 'Member'
  },
  'ishaan': {
    id: 'ishaan',
    name: 'Ishaan',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Ishaan&topType=shortHairTheCaesarSidePart',
    presence: 'offline',
    mutualServers: ['Developer Hangout'],
    role: 'Member'
  },
  'jyoti': {
    id: 'jyoti',
    name: 'Jyoti',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Jyoti&facialHairProbability=0&topType=longHairNotTooLong',
    presence: 'online',
    mutualServers: ['Developer Hangout'],
    role: 'Member'
  },
  'meera': {
    id: 'meera',
    name: 'Meera',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Meera&facialHairProbability=0&topType=longHairMiaWallace',
    presence: 'idle',
  ...
  'tushar': {
    id: 'tushar',
    name: 'Tushar',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Tushar&topType=shortHairShortWashed',
    presence: 'offline',
    mutualServers: ['Gamer Zone'],
    role: 'Member'
  },
  'prisha': {
    id: 'prisha',
    name: 'Prisha',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Prisha&facialHairProbability=0&topType=longHairBun',
    presence: 'idle',
    mutualServers: ['Gamer Zone'],
    role: 'Member'
  },
  'sneha': {
    id: 'sneha',
    name: 'Sneha',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Sneha&facialHairProbability=0&topType=longHairStraight2',
    presence: 'dnd',
    mutualServers: ['Gamer Zone'],
    role: 'Member'
  }
